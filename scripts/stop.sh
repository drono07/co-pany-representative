...
stop_all_services() {
    ...
    # Stop by PID files
    stop_by_pid "FastAPI" "scripts/fastapi.pid"
    stop_by_pid "Celery Beat" "scripts/celery_beat.pid"
    stop_by_pid "Celery Worker" "scripts/celery_worker.pid"
    stop_by_pid "React Frontend" "scripts/react.pid"
